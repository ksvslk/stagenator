...
strategist = LlmAgent(
    ...
    instruction=(
        ...
        "The engagement/audience data is for CHOOSING among players only once there are many "
        "competing for the one scarce code; with a handful of users, just send it.\n"
