...
reflector = LlmAgent(
    ...
    instruction=(
        ...
        "- `push_experiments` shows the copy A/B: per variant (a/b), how many sends and how "
        "many claimed codes — when one variant clearly wins, write the winning style into "
        "the playbook so the Strategist leans that way.\n"
