...
def design_level(used: set[str], culture: str | None = None) -> dict | None:
    ...
    reply = genai_client.generate_json(
        ...
        "Evoke the film through SETTING, objects, atmosphere, lighting and silhouettes — "
        "avoid recognizable real-person faces; if a figure must appear keep it "
        "non-identifiable (silhouette, back-turned, or obscured). "
